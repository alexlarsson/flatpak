                                   ...
                                   GError      **error)
{
  ...
  if (dirs_with_remote->len == 1)
    ...
    {
      g_auto(GStrv) names = g_new0 (char *, dirs_with_remote->len);
  ...
  if (chosen == 0)
    {
      if (ref_dir_pairs->len == 1)
        ...
        {
          g_auto(GStrv) names = g_new0 (char *, ref_dir_pairs->len);
  ...
  if (chosen == 0)
    {
      if (remote_dir_pairs->len == 1)
        ...
        {
          g_auto(GStrv) names = g_new0 (char *, remote_dir_pairs->len);
